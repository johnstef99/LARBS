...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/johnstef99/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/johnstef99/LARBS/master/progs.csv"
